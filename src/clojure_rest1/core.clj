...
;Mutable collection vector
(def people-collection (atom []))

;collection helper for adding a new person
(defn addperson [firstname surname] (swap! people-collection conj {:firstname (str/capitalize firstname)
